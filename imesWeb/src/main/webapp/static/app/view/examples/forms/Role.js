Ext.define('KitchenSink.view.examples.forms.RoleEdit' , 	{ 
		    extend:  'Ext.Window',
		    alias: 'chmade.RoleEdit',
		    refreshStore : null ,
...
Ext.define('KitchenSink.view.examples.forms.Role', {
    extend:  'Ext.panel.Panel',
    alias: 'chmade.sysRole',
    header: false,
    ...
    beforeRender: function() {
        var me = this;
        me.callParent();
     	pluginStore =  Ext.create('SysRoleStore');
       		        ...
       		        buttons: ['->', {
                       	...
                       	handler: function() {
		                       		...
		                       		st.on('beforeload', function (store, options) {
		                       			var new_params = baseRole;
		                       			Ext.apply(store.proxy.extraParams, baseRole) ;
		                       		}) ;
		                       		st.currentPage=1 ;
		                       		st.load( ) ;
                       	}
        		            ...
        		            text: 'Edit',
        		            	handler: function() {
        		            		...
        		            		if  ( selModel.length == 1 ) {
            		            		var p =  this.up('gridpanel').up().up() ;
            		            		var   constrainedWin = Ext.create(  'chmade.RoleEdit', { title:'Edit Role', constrainTo : p.getEl() , refreshStore: this.up('gridpanel').getStore()  } );
