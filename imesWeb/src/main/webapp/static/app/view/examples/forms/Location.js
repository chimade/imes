Ext.define('KitchenSink.view.examples.forms.LocationEdit' , 	{ 
		    extend:  'Ext.Window',
		    alias: 'chmade.LocationEdit',
		    refreshStore : null ,
			  ...
			  allowBlank:false
    		        ...
    		        buttons: [{
    		         ...
    		         ,   handler: function() {
    		                ...
    		                var beanModel = Ext.create('model.SysLocationModel',  formValues);
    		                beanModel.save({
...
Ext.define('KitchenSink.view.examples.forms.Location', {
    extend:  'Ext.panel.Panel',
    alias: 'chmade.sysLocation',
    header: false,
    ...
    beforeRender: function() {
        var me = this;
        me.callParent();
     	pluginStore =  Ext.create('SysLocationStore');
    ...
    items: [
    {
		...
		{ text:'process_id' ,		dataIndex:'processId' } ,
       		        ...
       		        buttons: ['->', {
                       	...
                       	handler: function() {
		                       		...
		                       		st.on('beforeload', function (store, options) {
		                       			var new_params = location;
		                       			Ext.apply(store.proxy.extraParams, location) ;
		                       		}) ;
		                       		st.currentPage=1 ;
		                       		st.load( ) ;
                       	}
       		        ...
       		        },
       		        {
       		            text: 'New',
       		            	handler: function() {
       		            		...
       		            		var   constrainedWin = Ext.create(  'chmade.LocationEdit', { title:'Add Location', constrainTo : p.getEl() , refreshStore: this.up('gridpanel').getStore() } );
       		            		constrainedWin.show();
       	                	}
       		        },{
        		            ...
        		            text: 'Edit',
        		            	handler: function() {
        		            		...
        		            		if  ( selModel.length == 1 ) {
            		            		var p =  this.up('gridpanel').up().up() ;
            		            		var   constrainedWin = Ext.create(  'chmade.LocationEdit', { title:'Edit Location', constrainTo : p.getEl() , refreshStore: this.up('gridpanel').getStore()  } );
        		            ...
        		            text: 'Delete',
        		            	handler: function() {
        		            		...
        		            		for(var k=0 ;k<selModel.length ;k++){
        		            			...
        		            			selModel[k].destroy({
        		            			    success: function() {
        		            			        console.log('The Location was destroyed!');
        		            			    }
        		            			});
        		            		}
